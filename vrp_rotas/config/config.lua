CONFIG = {
    ...
    ROUTES = {
        ['municao'] = { 
            ...
            PED = {
                LOCATION = vector3(1144.52, -299.53, 68.81), 
                HEADING = 102.09390258789, 
                HASHS = { 0x5B81D86C, 'u_f_y_spyactress' }, 
                TEXT = '~q~[E]~w~ PARA INICIAR A ROTA', 
            }, 
           
            PERMISSIONS = { 'fr.permissao', 'admin.permissao' }, 
            
            RANDOM_ITEMS = true, 
           
            ITEMS = {
                { NAME = 'polvora', MINIMUM = 4, MAXIMUM = 6 }, 
                { NAME = 'capsula', MINIMUM = 6, MAXIMUM = 8 }, 
            }, 
        ...
        ['maconha'] = { 
            ...
            PED = {
                LOCATION = vector3(1273.29, -122.79, 84.7), 
                HEADING = 140.28, 
                HASHS = { 0xF9FD068C, 'ig_vagspeak' }, 
                TEXT = '~r~[E]~w~ PARA INICIAR A ROTA', 
            }, 
           
            PERMISSIONS = 'sinaloa.permissao', 
           
            RANDOM_ITEMS = true, 
           
            ITEMS = {
                { NAME = 'adubo', MINIMUM = 3, MAXIMUM = 6 }, 
                { NAME = 'fertilizante', MINIMUM = 3, MAXIMUM = 6 }, 
            }, 
        ...
        ['desmanche'] = { 
            ...
            PED = {
                LOCATION = vector3(1304.01, -746.97, 73.99), 
                HEADING = 166.92, 
                HASHS = { 0xF9FD068C, 'ig_vagspeak' },  
                TEXT = '~r~[E]~w~ PARA INICIAR A ROTA', 
            }, 
           
            PERMISSIONS = { 'bratva.permissao', 'admin.permissao' }, 
            
            RANDOM_ITEMS = true, 
           
            ITEMS = {
                { NAME = 'solvente', MINIMUM = 2, MAXIMUM = 2 }, 
                { NAME = 'desoldagem', MINIMUM = 2, MAXIMUM = 2 }, 
            }, 
